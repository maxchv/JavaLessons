...
public class SqlTableModel extends AbstractTableModel {
	...
	private void getData() {
		try {			
			...
			// вставка данных
			rs.moveToInsertRow();
			rs.updateString("UserName", "Jhon");
			rs.updateString("FirstName", "Jhon");
			rs.updateString("LastName", "Kerry");
			rs.updateDate("DateOfBirth", Date.valueOf("1956-10-11"));
			rs.insertRow();
			System.out.println("inserted:" + rs.rowInserted());
			rs.moveToCurrentRow();
			i++;
